...
from voxceleb.model.ResNetBlocks import *
...
def MainModel(nOut=256, **kwargs): # nOut war 256 in original voxceleb aber checkpoint hat 512. siehe auch paper [1]
    # Number of filters
