...
from voxceleb.model.ResNetBlocks_6g import *
...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, nOut, encoder_type='SAP', n_mels=80, log_input=True, **kwargs):
        ...
        self.layer0_1 = ResNeXt(66, 66, kernel_size=3) 
        self.layer0_2 = ResNeXt(66, 66, kernel_size=3)
        self.layer0_3 = ResNeXt(66, 66, kernel_size=3)
