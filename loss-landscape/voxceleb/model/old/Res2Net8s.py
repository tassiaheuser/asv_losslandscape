...
from voxceleb.model.ResNetBlocks_8s import *
...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, nOut, encoder_type='SAP', n_mels=80, log_input=True, **kwargs):
        ...
        self.layer0_1 = Res2NeXt(64, 64, kernel_size=3, scale=8)
        self.layer0_2 = Res2NeXt(64, 64, kernel_size=3, scale=8)
        self.layer0_3 = Res2NeXt(64, 64, kernel_size=3, scale=8)
