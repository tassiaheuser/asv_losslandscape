...
#SBATCH --error=/home/lenny/slurm_logs/Rv2.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/Rv2.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/incResRandom/random_vox2_v2.yaml
