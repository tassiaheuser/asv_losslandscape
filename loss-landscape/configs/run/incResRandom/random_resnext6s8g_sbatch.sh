...
#SBATCH --error=/home/lenny/slurm_logs/R6s8g.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/R6s8g.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/incResRandom/random_resnext6s8g_train.yaml
