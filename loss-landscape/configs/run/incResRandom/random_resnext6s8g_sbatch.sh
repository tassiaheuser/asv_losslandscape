...
#SBATCH --error=slurm_logs/R6s8g.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=slurm_logs/R6s8g.%J.out
...
python plot_surface.py --config configs/run/incResRandom/random_resnext6s8g_train.yaml
