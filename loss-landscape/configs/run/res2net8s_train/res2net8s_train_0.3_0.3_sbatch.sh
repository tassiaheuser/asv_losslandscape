...
#SBATCH --error=slurm_logs/8s_0.3_0.3.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=slurm_logs/8s_0.3_0.3.%J.out
...
python plot_surface.py --config configs/run/res2net8s_train/res2net8s_train_0.3_0.3.yaml
