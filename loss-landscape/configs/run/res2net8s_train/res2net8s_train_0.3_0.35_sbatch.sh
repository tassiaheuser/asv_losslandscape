...
#SBATCH --job-name=8s_0.3_0.35  #6gIncRes
...
#SBATCH --error=/home/lenny/slurm_logs/8s_0.3_0.35.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/8s_0.3_0.35.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/res2net8s_train/res2net8s_train_0.3_0.35.yaml
