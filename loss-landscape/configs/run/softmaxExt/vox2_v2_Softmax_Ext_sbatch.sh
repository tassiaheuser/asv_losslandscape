...
#SBATCH --job-name=SMExt  #6gIncRes
...
#SBATCH --error=/home/lenny/slurm_logs/SMExt.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/SMExt.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/softmaxExt/vox2_v2_Softmax_Ext.yaml
