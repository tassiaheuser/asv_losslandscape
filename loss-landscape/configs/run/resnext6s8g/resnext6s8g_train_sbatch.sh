...
#SBATCH --error=/home/lenny/slurm_logs/tr6s8g.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/tr6s8g.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/resnext6s8g/resnext6s8g_train.yaml
