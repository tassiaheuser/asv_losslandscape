...
#SBATCH --error=slurm_logs/6s8g353.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=slurm_logs/6s8g353.%J.out
...
python plot_surface.py --config configs/run/resnext6s8g/resnext6s8g_train_0.35_0.3.yaml
