...
#SBATCH --job-name=6s8g353  #tr6s8g
...
#SBATCH --error=/home/lenny/slurm_logs/6s8g353.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/6s8g353.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/resnext6s8g/resnext6s8g_train_0.35_0.3.yaml
