...
#SBATCH --job-name=trj-3-3.5  #trjec
...
#SBATCH --error=/home/lenny/slurm_logs/trj-3.0-3.5.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/lenny/slurm_logs/trj-3.0-3.5.%J.out
...
python /mnt/ssd2/Tassi/TassiMA/loss-landscape/plot_surface.py --config /mnt/ssd2/Tassi/TassiMA/loss-landscape/configs/run/resnext6s8g_balancedTraining/resnext6s8g_balancedTraining_0.3_0.35.yaml
