...
#SBATCH --error=slurm_logs/trj-3.5-3.0%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=slurm_logs/trj-3.5-3.0%J.out
...
python plot_surface.py --config configs/run/resnext6s8g_balancedTraining/resnext6s8g_balancedTraining_0.35_0.3.yaml
