...
class LossFunction(nn.Module):
    def __init__(self, nOut, nClasses, margin=0.2, scale=30, easy_margin=False,return_full_pred=False, **kwargs): #used to be scale=15, margin=0.3
    ...
    def forward(self, x, label=None):
        ...
        if self.return_full_pred:
            return loss, prec1, output.softmax(dim=1), label
        return loss, prec1